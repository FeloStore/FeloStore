...
import app.FeloStore.client.receivers.AppStatusChangeBroadcastReceiver
import app.FeloStore.client.util.registerReceiverNotExported
...
@HiltAndroidApp
class FeloStore : Application(), Configuration.Provider {
    @Inject
